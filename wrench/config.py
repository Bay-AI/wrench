...
DEFAULT_BACKBONE_CONFIG = {"name": "MLP", "paras": DEFAULT_MLP_CONFIG}
...
DEFAULT_LABEL_MODEL_CONFIG = {"name": "MajorityVoting", "paras": {}}
        ...
        if hasattr(self, "backbone_config"):
            if "backbone" in kwargs:
                ...
                if backbone_ != self.backbone_config["name"]:
                    ...
                    self.backbone_config["paras"] = DEFAULT_BACKBONE_MAP[
                        kwargs["backbone"]
                    ].copy()
