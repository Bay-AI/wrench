...
class CHMMArguments:
    ...
    test_file: Optional[str] = field(default="", metadata={"help": "test data name"})
    output_dir: Optional[str] = field(
        default=".",
        metadata={
            "help": "The output folder where the model predictions and checkpoints will be written."
        },
    )
    trans_nn_weight: Optional[float] = field(
        default=1,
        metadata={"help": "the weight of neural part in the transition matrix"},
    )
    ...
    num_valid_tolerance: Optional[int] = field(
        default=5,
        metadata={"help": "How many tolerance epochs before quiting training"},
    )
    hmm_lr: Optional[float] = field(
        default=0.01,
        metadata={
            "help": "learning rate of the original hidden markov model transition and emission"
        },
    )
    ...
    log_dir: Optional[str] = field(
        default="",
        metadata={
            "help": "the directory of the log file. Set to '' to disable logging"
        },
    )
